    ...
    <table border=1 class="table-container">
        ...
        <tbody>
            ...
            while ($datauser = mysqli_fetch_array($query)) {
                ...
                echo "<td>";
                echo "<form action='up-nilai.php' method='GET' style='display:inline;'>";
                echo "<input type='hidden' name='username' value='" . $datauser['username'] . "'>";
                echo "<button type='submit'>Edit Nilai</button>";
                echo "</form>";
                echo "<form action='del-nilai.php' method='POST' style='display:inline;'>";
                echo "<input type='hidden' name='username' value='" . $datauser['username'] . "'>";
                echo "<button type='submit' onclick=\"return confirm('Apakah Anda yakin ingin menghapus nilai ini?');\">Hapus Nilai</button>";
                echo "</form>";
                echo "</td>";
                echo "</tr>";
                $i++;
